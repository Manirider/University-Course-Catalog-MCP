...
class SearchCoursesInput(BaseModel):
    query: Annotated[
        ...
        Field(
            min_length=1,
            max_length=200,
            description="Search query for course code, title, or description",
        ),
    ]
    department_code: Annotated[
        ...
        Field(
            default=None,
            max_length=50,
            description="Optional department code to filter results",
        ),
    ] = None
...
class GetPrerequisitesInput(BaseModel):
    course_code: Annotated[
        ...
        Field(
            min_length=1,
            max_length=50,
            description="Course code to get prerequisites for",
        ),
    ]
...
class GetPrerequisitesResult(BaseModel):
    ...
    prerequisites: Annotated[
        ...
        Field(description="List of direct prerequisite courses"),
    ]
    ...
    class Config:
        json_schema_extra = {  # noqa: RUF012
            "example": {
                "course_code": "CS301",
                "prerequisites": [{"course_code": "CS102", "title": "Data Structures"}],
            }
        }


class LookupInstructorInput(BaseModel):
    instructor_name: Annotated[
        str,
        Field(
            min_length=1, max_length=255, description="Instructor name to search for"
        ),
    ]
...
class PrerequisiteGraphInput(BaseModel):
    course_code: Annotated[
        ...
        Field(
            min_length=1,
            max_length=50,
            description="Course code to get prerequisite graph for",
        ),
    ]
...
class PrerequisiteGraphResult(BaseModel):
    nodes: Annotated[
        list[GraphNode], Field(description="All courses in the prerequisite graph")
    ]
    edges: Annotated[
        list[GraphEdge],
        Field(description="Prerequisite relationships (source -> target)"),
    ]
...
class HealthResponse(BaseModel):
    ...
    database: Annotated[
        str | None, Field(default=None, description="Database connection status")
    ] = None
